...
import { API_URL as DEFAULT_API_URL } from './backend';
...
// 🔥 NOUVEAU: Type spécifique pour les réponses de synchronisation
...
// 🔥 NOUVEAU: Client API spécial pour les endpoints de sync (retourne la structure complète)
...
// 🔥 Endpoints Synchronisation - UTILISE LE TYPE SPÉCIFIQUE
export const syncApi = {
  ...
  // 🔥 MODIFIÉ: Utilise syncApiRequest et retourne SyncPushResponse
  async push(data: {
    receptions?: any[];
    retours?: any[];
    inventaires?: any[];
    ...
    return syncApiRequest('/sync/push', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },
